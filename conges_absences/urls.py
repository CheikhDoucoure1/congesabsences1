...
urlpatterns = [
    ...
    path('administration/employes/<int:employe_id>/modifier/', views.modifier_employe, name='modifier_employe'),
    path('administration/employes/<int:employe_id>/toggle-actif/', views.toggle_actif_employe, name='toggle_actif_employe'),
